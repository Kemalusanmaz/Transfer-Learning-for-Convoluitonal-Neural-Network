...
trafficSignDataFolder=fullfile(...
    "C:\Users\kemal\Desktop\Tez_Trafik İşaretleri Tanıma_Kod\gtsrb-preprocessed\train_increased\");

% İhtiyaç varsa GPU'nun YSA'yı çalıştırıp çalıştırmayacağı çıktısını verir.
